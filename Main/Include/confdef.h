...
#define VALPURIS_METAL (SOLID_ID + 1)
...
#define BRAMBLEBACK_HAIR (SOLID_ID + 39)
...
#define MANGO_PEEL (ORGANIC_ID + 3)
#define MANGO_FLESH (ORGANIC_ID + 4)
#define SACRED_MANGO_FLESH (ORGANIC_ID + 5)
#define KIWI_FLESH (ORGANIC_ID + 6)
#define PINEAPPLE_FLESH (ORGANIC_ID + 7)
#define CARROT_FLESH (ORGANIC_ID + 8)
#define TROPICAL_MANGO_FLESH (ORGANIC_ID + 9)
...
#define BLIGHTTOAD_BLOOD (LIQUID_ID + 41)
#define SPIDER_BLOOD (LIQUID_ID + 42)
#define ACIDOUS_BLOOD (LIQUID_ID + 43)
#define SICK_BLOOD (LIQUID_ID + 44)
#define MARSH_TOAD_BLOOD (LIQUID_ID + 45)
#define BRAMBLEBACK_BLOOD (LIQUID_ID + 46)
#define BRAMBLEBACK_URINE (LIQUID_ID + 47)
#define BRAMBLEBACK_SWEAT (LIQUID_ID + 48)
#define BRAMBLEBACK_TEARS (LIQUID_ID + 49)
#define BRAMBLEBACK_SNOT (LIQUID_ID + 50)
...
#define BLIGHTTOAD_FLESH (FLESH_ID + 9)
#define MALGORATH_FLESH (FLESH_ID + 10)
...
#define WRAITHSTALKER_FLESH (FLESH_ID + 16)
...
#define THORNBACK_PORCUPINE_FLESH (FLESH_ID + 44)
